...
public class Sobre extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        lbIcone.setIcon(new javax.swing.ImageIcon(getClass().getResource("/projVendas/gui/img/sobre.png"))); // NOI18N
        ...
        taTexto.setRows(5);
        taTexto.setText("Sistema de Vendas\nAutor: João Marcelo Monteiro\nE-mail: marcelodjmix2013@gmail.com\nSuporte: 98 9 82949331\n\nAplicação desenvolvida com a intenção de\najudar o varejo com o controle de dados \ndos produtos, clientes e fornecedores.");
